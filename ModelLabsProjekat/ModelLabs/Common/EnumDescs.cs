...
namespace FTN.Common
{
	public class EnumDescs
	{
		...
		public EnumDescs()
		{
			...
			property2enumType.Add(ModelCode.BIS_VALUNIT, typeof(UnitSymbol));
			property2enumType.Add(ModelCode.REGCONTROL_MODE, typeof(RegulatingControlModeKind));
			property2enumType.Add(ModelCode.REGCONTROL_MONITORPHASE, typeof(PhaseCode));
